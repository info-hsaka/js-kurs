...
<MonacoEditor
 ...
 showOutput={true}
 transitionText='console.log() erwartet einen String zwischen den () und gibt diesen dann in der Konsole aus. Dieses Programm gibt'
 showRunButton={true}
/>
...
console.log(foo)`
 ...
 showOutput={true}
 transitionText='dieses Programm gibt'
 showRunButton={true}
/>
